...
public class ProjectTaskService {
    ...
    public ProjectTask addProjectTask(String projectIdentifier, ProjectTask projectTask, String username){
            ...
            List<String> userList=projectTask.getUserName(); 
            ...
            return projectTaskRepository.save(projectTask);
    				...
    				throw new UserNotFoundException("Please assign valid users");
    			}
	...
	public List<String> findPTByProjectSequenceUsers(String backlog_id, String pt_id, String name) {
		// TODO Auto-generated method stub
		System.out.println(pt_id);
		ProjectTask projectTask = findPTByProjectSequence(backlog_id, pt_id, name);
		Long idLong=projectTask.getId();
		 return projectTaskRepository.findAllusers(idLong);
	}
}
