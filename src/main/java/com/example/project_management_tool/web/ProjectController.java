...
public class ProjectController {
    ...
    @GetMapping("/all")
    public Iterable<Project> getAllProjects(Principal principal){return projectService.findAllProjects();}


    //deleting project by projectId
    @DeleteMapping("/{projectId}")
    public ResponseEntity<?> deleteProject(@PathVariable String projectId, Principal principal){
    	Long pidLong=Long.parseLong(projectId);
        projectService.deleteProjectByIdentifier(pidLong);
