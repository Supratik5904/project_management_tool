...
public class BacklogController {
    ...
    public ResponseEntity<?> updateProjectTask(@Valid @RequestBody ProjectTask projectTask, BindingResult result,
        ...
        System.out.println("back id"+backlog_id);
    ...
    @GetMapping("/{backlog_id}/{pt_id}/users")
    public ResponseEntity<?> getProjectTaskUser(@PathVariable String backlog_id, @PathVariable String pt_id, Principal principal){
        List<String> users = projectTaskService.findPTByProjectSequenceUsers(backlog_id, pt_id, principal.getName());
